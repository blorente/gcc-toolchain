...
def _gcc_toolchain_impl(rctx):
    print("BL: _gcc_toolchain_impl(name={})".format(rctx.name))
...
def gcc_register_toolchain(
    ...
    """
    print("BL: defs.bzl:gcc_register_toolchain(name={}, target_arch={})".format(name, target_arch))
